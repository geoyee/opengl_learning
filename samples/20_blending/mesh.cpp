    ...
    , m_texs({})
{
    ...
    setupMesh(textures, start_tex_id);
}
...
void Mesh::setupMesh(const std::vector<std::pair<std::string, std::string>>& textures, unsigned int start_id)
{
