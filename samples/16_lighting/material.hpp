...
struct Material
{
    ...
    glm::vec3 diffuse;
    glm::vec3 specular;
    float shininess; // OpenGL: Multiply the shininess by 128
};
...
struct constexpr_map
{
    ...
    constexpr const Value& at(Key key) const
    {
...
// clang-format off
constexpr auto g_materialMap = constexpr_map<std::string_view, Material, 24>{
    {std::pair{"emerald",
               Material{glm::vec3(0.0215f, 0.1745f, 0.0215f),
                        glm::vec3(0.07568f, 0.61424f, 0.07568f),
                        glm::vec3(0.633f, 0.727811f, 0.633f),
                        0.6f}},
     std::pair{"jade",
               Material{glm::vec3(0.135f, 0.2225f, 0.1575f),
                        glm::vec3(0.54f, 0.89f, 0.63f),
                        glm::vec3(0.316228f, 0.316228f, 0.316228f),
                        0.1f}},
     std::pair{"obsidian",
               Material{glm::vec3(0.05375f, 0.05f, 0.06625f),
                        glm::vec3(0.18275f, 0.17f, 0.22525f),
                        glm::vec3(0.332741f, 0.328634f, 0.346435f),
                        0.3f}},
     std::pair{"pearl",
               Material{glm::vec3(0.25f, 0.20725f, 0.20725f),
                        glm::vec3(1.0f, 0.829f, 0.829f),
                        glm::vec3(0.296648f, 0.296648f, 0.296648f),
                        0.088f}},
     std::pair{"ruby",
               Material{glm::vec3(0.1745f, 0.01175f, 0.01175f),
                        glm::vec3(0.61424f, 0.04136f, 0.04136f),
                        glm::vec3(0.727811f, 0.626959f, 0.626959f),
                        0.6f}},
     std::pair{"turquoise",
               Material{glm::vec3(0.1f, 0.18725f, 0.1745f),
