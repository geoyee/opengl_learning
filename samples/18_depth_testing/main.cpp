...
int main()
{
...

    {
        ...
        Shader shader({
            ...
            {GL_FRAGMENT_SHADER, shader_path + "depth_fragment.glsl"}
        });
        // ******************************************************************************
        ...
        float u_near = 0.5f, u_far = 100.0f;
        ...
        while (!glfwWindowShouldClose(window))
        {
            ...
            shader.setUniform1f("u_Near", u_near);
            shader.setUniform1f("u_Far", u_far);
            glm::mat4 proj =
            ...
            ImGui::SliderFloat("Z-Buffer Near", &u_near, 0.01f, 100.0f);
            ImGui::SliderFloat("Z-Buffer Far", &u_far, 0.01f, 100.0f);
            ImGui::End();
